    ...
    return (
        <div className='bg-[#fff]'>
            ...
            <div className='cont'>
                ...
                <div className='cont1'>
                    <img style={{ display: "revert" }} src="https://s3-alpha-sig.figma.com/img/2bf9/3a71/d8003e7c5abaae02be0c524fe88ec378?Expires=1704067200&Signature=YKynceNdJryC~zSYDot37n0nCQc0RbYGGDA2-PDsvnP3CRoKlFq~oKU3IfmFgXQBV47i-3wB6yb9kooiMeKtaQj-FkC3eynHZqLuWtz6ATncxZaWi~5PUcePTKpMoZ9RcSLd8gr5QF05qGgl2WnZhGjUtHyJ6lSCJRv4N3KeNoG~A~2vVj4NezEUntk2UgTeSsA~LPBHimfVavRB~CFmaWVAQmLcCXCk7-J~rbUT0pxaFGWTesr0hzSh-fGVEODstKAJoScKFzI5POLdVopdwmCPSgnbmFi5tkoDyyhsld0jLpLIgzYBjPy0KxiyPK0b2AOIng53b9C0gleH8XhVSQ__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" alt="" />
                    <h1>Albert Flores</h1>
                    <p>Career Educator</p>
